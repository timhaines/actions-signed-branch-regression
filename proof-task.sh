...
git push origin HEAD:refs/heads/signed-chain-1
...
GH_TOKEN=$token gh api -X POST "repos/$GITHUB_REPOSITORY/actions/workflows/release-proof.yml/dispatches" -f ref=signed-chain-1
printf 'SIGNED_ARM source_sha=%s pushed and dispatched\n' "$source_sha"
